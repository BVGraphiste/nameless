...
(function ($) {
    ...
    $.fn.SumoSelect = function (options) {
        ...
        var settings = $.extend({
            placeholder: 'Selectionnez',   // Dont change it here.
        ...
        var ret = this.each(function () {
            ...
            this.sumo = {
                ...
                createElems: function () {
                    var O = this;
                    O.E.wrap('<div class="select-container" tabindex="0">');
                    O.select = O.E.parent();
                    O.caption = $('<span></span>');
                    O.CaptionCont = $('<p class="select-caption"><label><i></i></label></p>').attr('style', O.E.attr('style')).prepend(O.caption);
                    ...
                    //## Creating the list...
                    O.optDiv = $('<div class="select-options">');
                ...
                multiSelelect: function () {
                    ...
                    O.okbtn = $('<p class="select-ok">OK</p>').click(function () {
                    ...
                    O.cancelBtn = $('<p class="select-cancel">Annuler</p>').click(function () {
                        O._cnbtn();
                        O.hideOpts();
                    });
                    O.optDiv.append($('<div class="select-controls">').append(O.okbtn).append(O.cancelBtn));
                },
...
//                                O.hideOpts();
                ...
                hideOpts: function () {
                    var O = this;
                    O.is_opened = false;
                    O.optDiv.parent().removeClass('open').find('ul li.sel').removeClass('sel');
